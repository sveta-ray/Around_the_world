...
public class Location12 {
    ...
    public Location12(int x, int y, MyFrame frame) throws IOException {
        this.frame = frame;
        this.x = 440;
        this.y = 555;
        this.w = 1641;
...
//        answert14 = ImageIO.read(new File("data\\Goal answer.png"));
        pr = 8;
        image = ImageIO.read(new File("data\\Location 12.png"));
        thing1 = new Thing(695, 585, 20, 15, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thing2 = new Thing(930, 585, 15, 15, new ThingAction() {
            @Override
...
//                         BufferedImage image01 = ImageIO.read(new File("data\\circle.png"));
        ...
        thing3 = new Thing(600, 170, 25, 20, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thing4 = new Thing(1545, 505, 15, 15, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thing5 = new Thing(70, 870, 10, 15, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thing6 = new Thing(300, 600, 25, 25, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thing7 = new Thing(620, 850, 20, 20, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thing8 = new Thing(75, 360, 20, 20, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thing9 = new Thing(1460, 465, 15, 20, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thing10 = new Thing(310, 880, 30, 15, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thing11 = new Thing(1205, 820, 25, 20, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thing12 = new Thing(1220, 330, 25, 15, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thing13 = new Thing(1565, 660, 20, 20, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thingS = new Thing(1530, 400, 50, 20, new ThingAction() {
            @Override
            public void onClick() {
...
//            g.drawString("Переход на следующий уровень", 500, 100);
            ...
            if (this.what) {
                ...
                BufferedImage imagee = ImageIO.read(new File("data\\Find 12.png"));
