...
//    Thing thing15;
    ...
    public Location5(int x, int y, MyFrame frame) throws IOException {
        this.frame = frame;
        this.x = 440;
        this.y = 555;
        //        this.w = 1641;
//        this.h = 1050;
        ...
        t4=false;
        t8=false;
        image = ImageIO.read(new File("data\\Location 5.png"));

        thing1 = new Thing(350, 110, 20, 20, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thing2 = new Thing(195, 570, 20, 20, new ThingAction() {
            @Override
...
//                         BufferedImage image01 = ImageIO.read(new File("data\\circle.png"));
        ...
        thing3 = new Thing(1030, 795, 25, 20, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thing4 = new Thing(270, 590, 20, 25, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thing5 = new Thing(495, 385, 20, 15, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thing6 = new Thing(0, 180, 25, 20, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thing7 = new Thing(1310, 660, 20, 20, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thing8 = new Thing(1175, 245, 20, 15, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thing9 = new Thing(760, 525, 20, 15, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thing10 = new Thing(1140, 225, 25, 20, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thing11 = new Thing(740, 380, 20, 10, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thing12 = new Thing(300, 230, 25, 15, new ThingAction() {
            @Override
            public void onClick() {
...
////        thing13 = new Thing(1415, 280, 25, 15, new ThingAction() {
//            @Override
//            public void onClick() {
//
//
//            }
//        });
//        thing14 = new Thing(1415, 280, 25, 15, new ThingAction() {
//            @Override
//            public void onClick() {
//
//
//            }
//        });
//        thing15 = new Thing(1415, 280, 25, 15, new ThingAction() {
//            @Override
//            public void onClick() {
//
//
...
//        });
        ...
        thingS = new Thing(320, 700, 40, 25, new ThingAction() {
            @Override
            public void onClick() {
    ...
    public void atClick(int a, int b){
        ...
        if(expl && a>0){
            ...
            if (x1 >945 && x1 < 1066 && y1 > 944 && y1 < 1045) {   //что ищем
                what = true;
            } else {
                what = false;
            }
        ...
        if(togo1 && x1>410 && x1<410+410 && y1>262 && y1<262+526){
            togo=true;
        }
...
//            g.drawString("Переход на следующий уровень", 500, 100);
            ...
            if (what) {
                ...
                BufferedImage imagee = ImageIO.read(new File("data\\Find 5.png"));
