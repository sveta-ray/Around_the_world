...
//    Thing thing11;
    ...
    public Location9(int x, int y, MyFrame frame) throws IOException {
        this.frame = frame;
        this.x = 440;
        this.y = 555;
        this.w = 1641;
...
//        answert14 = ImageIO.read(new File("data\\Goal answer.png"));
        pr = 7;
        image = ImageIO.read(new File("data\\Location 9.png"));
        thing1 = new Thing(1415, 885, 25, 25, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thing2 = new Thing(760, 110, 15, 15, new ThingAction() {
            @Override
...
//                         BufferedImage image01 = ImageIO.read(new File("data\\circle.png"));
        ...
        thing3 = new Thing(330, 490, 20, 15, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thing4 = new Thing(900, 360, 20, 20, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thing5 = new Thing(1295, 525, 20, 20, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thing6 = new Thing(1315, 40, 20, 20, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thing7 = new Thing(460, 50, 20, 20, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thing8 = new Thing(1425, 410, 25, 20, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thing9 = new Thing(600, 810, 25, 15, new ThingAction() {
            @Override
            public void onClick() {
...
//        thing10 = new Thing(505, 650, 15, 15, new ThingAction() {
//            @Override
//            public void onClick() {
//
//
...
////            }
//        });
        thingS = new Thing(1595, 870, 30, 25, new ThingAction() {
            @Override
            public void onClick() {
...
//        things.add(thing12);
    ...
    public void atClick(int a, int b) {
        ...
        if(expl && a>0){
            ...
            if (x1 > 1130 && x1 < 1300 && y1 > 920 && y1 < 1045) {   //что ищем
                what = true;
            } else {
                what = false;
            }
...
//            g.drawString("Переход на следующий уровень", 500, 100);
            ...
            if (this.what) {
                ...
                BufferedImage imagee = ImageIO.read(new File("data\\Find 9.png"));
