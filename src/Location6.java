...
//    Thing thing15;
    ...
    public Location6(int x, int y, MyFrame frame) throws IOException {
        this.frame = frame;
        this.x = 440;
        this.y = 555;
        //        this.w = 1641;
//        this.h = 1050;
        ...
        l=12;
        this.togo1 = false;
        image = ImageIO.read(new File("data\\Location 6.png"));
        thing1 = new Thing(1580, 450, 20, 15, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thing2 = new Thing(1150, 480, 25, 25, new ThingAction() {
            @Override
...
//                         BufferedImage image01 = ImageIO.read(new File("data\\circle.png"));
        ...
        thing3 = new Thing(1420, 835, 25, 25, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thing4 = new Thing(1465, 840, 20, 20, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thing5 = new Thing(1530, 185, 20, 20, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thing6 = new Thing(1225, 35, 20, 30, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thing7 = new Thing(775, 175, 15, 15, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thing8 = new Thing(1210, 625, 30, 20, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thing9 = new Thing(505, 590, 20, 30, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thing10 = new Thing(130, 305, 25, 20, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thing11 = new Thing(335, 680, 30, 20, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thing12 = new Thing(585, 925, 40, 20, new ThingAction() {
            @Override
            public void onClick() {
...
//        });
        ...
        thingS = new Thing(1285, 170, 45, 25, new ThingAction() {
            @Override
            public void onClick() {
...
//            g.drawString("Переход на следующий уровень", 500, 100);
            ...
            if (what) {
                ...
                BufferedImage imagee = ImageIO.read(new File("data\\Find 6.png"));
