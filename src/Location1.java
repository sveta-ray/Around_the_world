...
//    BufferedImage image1;
    ...
    public Location1(int x, int y, MyFrame frame) throws IOException {
        this.frame = frame;
        this.x = 440;
        this.y = 555;
        this.w = 1641;
...
//        this.h = frame.height;
        ...
        pr = 7;
        image = ImageIO.read(new File("data\\Location 1.png"));
//        image1 = ImageIO.read(new File("data\\findmap.png"));
        thing1 = new Thing(440, 570, 20, 25, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thing2 = new Thing(715, 170, 20, 25, new ThingAction() {
            @Override
...
//                         BufferedImage image01 = ImageIO.read(new File("data\\circle.png"));
        ...
        thing3 = new Thing(1190, 215, 20, 25, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thing4 = new Thing(1400, 720, 20, 25, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thing5 = new Thing(1230, 830, 20, 25, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thing6 = new Thing(1355, 625, 25, 15, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thing7 = new Thing(935, 225, 25, 15, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thing8 = new Thing(830, 35, 15, 10, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thing9 = new Thing(845, 895, 15, 10, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thing10 = new Thing(1550, 855, 20, 10, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thing11 = new Thing(1035, 590, 15, 10, new ThingAction() {
            @Override
            public void onClick() {
        ...
        thingS = new Thing(385, 280, 40, 15, new ThingAction() {
            @Override
            public void onClick() {
...
//        }
        ...
        }if(1035<x1 && 590<y1 && 1035+ 15>x1 && 590+ 10>y1){
            this.t11=true;
            for(int i = 0; i < frame.inventory.size(); i = i + 1){
...
//            g.drawString("Переход на следующий уровень", 500, 100);
            ...
            if (what) {
                ...
                BufferedImage imagee = ImageIO.read(new File("data\\Find 1.png"));
